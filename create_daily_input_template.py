...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create daily_input template and sample CSV files from data/stocks_master.csv."
    )
    parser.add_argument(
        "--input",
        type=Path,
...
def main() -> None:
    args = parse_args()
    row_count = create_daily_input_files(args.input, args.output, args.sample_output)
